...
let RemoteTodoService = class RemoteTodoService {
    ...
    getTodos() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this._api.get("api/Todo");
    ...
    getTodo(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._dialogService.showLoadingScreen();
            try {
                const response = yield this._api.get(`api/Todo/${id.trim().toLowerCase()}`);
    ...
    createTodo(title, description) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._dialogService.showLoadingScreen();
            try {
                const response = yield this._api.post("api/Todo", command);
    ...
    updateTodo(id, title, description) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._dialogService.showLoadingScreen();
            try {
                const response = yield this._api.put(`api/Todo/${id}`, command);
    ...
    markTodoAsCompleted(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._dialogService.showLoadingScreen();
            try {
                const response = yield this._api.put(`api/Todo/${id.trim().toLowerCase()}/MarkAsCompleted`);
    ...
    deleteTodo(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._dialogService.showLoadingScreen();
            try {
                const response = yield this._api.delete(`api/Todo/${id.trim().toLowerCase()}`);
